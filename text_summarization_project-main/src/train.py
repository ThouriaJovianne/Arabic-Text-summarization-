class Train(object):
    ...
    def process_train_batch(self, batch):   
        ...
        inputs, labels = batch['text'].clone().detach(), batch['summary'].clone().detach()
    ...
    def train_model(self, train_dataloader, val_dataloader):
        ...
        for epoch_i in range(0, epochs):
            ...
            if (epoch_i + 1)% 10 == 0: 
                ...
                path = os.path.join(self.final_model, str(epoch_i+1))  # Corrected path
                self.save_model(path)  # Corrected saving path
